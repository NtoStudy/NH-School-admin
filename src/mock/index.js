...
Mock.mock('/notices', 'get', () => {
  return {
    data: [
      {
        id: 1,
        context: '一站式学生社区服务大厅首批入驻办理事项',
        showTop: true,
        time: '2024.02.05'
      },
      {
        id: 2,
        context: '辅导员考核学生评分操作步骤说明',
        showTop: true,
        time: '2023.12.30'
      },
      {
        id: 3,
        context: '助学贷款学工系统提交步骤',
        showTop: false,
        time: '2024.01.03'
      },
      {
        id: 4,
        context: '综合测评学生自行提交操作',
        showTop: false,
        time: '2023.12.31'
      },
      {
        id: 5,
        context: '学工系统暑期留校申请说明',
        showTop: false,
        time: '2023.08.05'
      },
      {
        id: 6,
        context: '如何进行本学年的学费缴费',
        showTop: false,
        time: '2023.07.05'
      }
    ]
...
Mock.mock('/allNoticesList', 'get', () => {
  return {
    data: [
      ...
      {
        id: 10,
        context: '实习就业信息发布平台介绍',
        showTop: false,
        time: '2024.09.15'
      },
      {
        id: 11,
        context: '图书馆借阅规则及预约流程',
        showTop: false,
        time: '2024.09.20'
      },
      {
      ...
      {
        id: 13,
        context: '学生社团注册及活动申请流程',
        showTop: false,
        time: '2024.10.01'
      },
      {
        id: 14,
        context: '校内奖学金申请条件及流程',
        showTop: false,
        time: '2024.10.05'
      },
      {
...
Mock.mock('/homeDownload', 'get', () => {
  return {
    data: [
      {
        id: 1,
        context: '假期留校家长意见书及安全责任协议',
        time: '2024.02.05'
      },
